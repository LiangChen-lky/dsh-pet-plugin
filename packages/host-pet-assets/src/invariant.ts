/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-host-pet-assets`.
 * @module @deepseek-ai/dsh-host-pet-assets/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-host-pet-assets'
